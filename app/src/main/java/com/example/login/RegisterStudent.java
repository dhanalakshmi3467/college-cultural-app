...
protected String dolnBackground(String... params) {
        ...
        String username = params[2]; String password = params[3]; String email = params[4];
        URL url = new URL(login_url);
        HttpURLConnection httpURLConnection = (HttpURLConnection)url.openConnection(); httpURLConnection.setRequestMethod("POST"); httpURLConnection.setDoOutput(true);
        httpURLConnection.setDolnput(true);
